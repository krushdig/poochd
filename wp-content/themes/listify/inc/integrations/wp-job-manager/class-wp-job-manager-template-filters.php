...
<div class="search-sort">
	...
	<select id="search_sort" class="job-manager-filter" name="search_sort" autocomplete="off">
		<option value="default" selected="selected"><?php esc_html_e( 'Sort by', 'listify' ); ?></option>
...
<?php
	...
	public static function sort_listings_result( $query_args, $args = array() ) {
		...
		if ( 'default' === $request['search_sort'] ) { // Default show featured.
...
<?php
	...
	public static function job_manager_job_filters_distance() {
		$checked = apply_filters( 'listify_search_by_radius', true );
	...
	?>
		...
		<div class="search-radius-wrapper<?php if ( $checked ) : ?> in-use<?php endif; ?>">
			<div class="search-radius-label">
				<label for="use_search_radius">
					<input type="hidden" name="use_search_radius" id="use_search_radius" value="<?php echo $checked; ?>" />
